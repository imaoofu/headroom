...
> **Status: complete in structure, still a draft in places.** Results rest on **698 committed
...
a locked protocol: **698 sweeps across four chips and three architectures**, of which 695
are dataset-grade — 526 on
