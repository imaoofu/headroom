...
> **Status: complete in structure, still a draft in places.** Results rest on **408 committed
...
a locked protocol: **408 dataset-grade sweeps across four chips and three architectures** — 348 on
