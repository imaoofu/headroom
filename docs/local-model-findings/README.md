...
|---|---|---|---|
| 2026-09-24 | [Claude Code as the harness: L1 as an agent](2026-09-24-claude-code-harness-L1.md) | After a one-line chat-template fix (every request had failed with HTTP 500), the agent passed the hidden check **15 of 15**, then ran out of context (73,370 of 65,536 tokens) before its summary. n = 1 | Not yet reviewed line by line and not installed; context is the binding limit |
