...
same one AGENTS.md already states: **search before claiming, not after writing.**
...
quoted. Nothing else in AGENTS.md restates them; if you find a second copy, delete it rather than
update it.
...
| file | answers |
|---|---|
| `AGENTS.md` | **what is technically established** and must not be re-derived, plus the standards |
...
and AGENTS.md has carried two contradictory ones simultaneously.
